"""Generate THE_SUBMISSION.pdf from markdown."""
...
with open('docs/THE_SUBMISSION.md', 'r', encoding='utf-8') as f:
    md = f.read()
...
safe_multi(pdf, W, 10, sanitize('The Riemann Hypothesis Proved via the Hadamard Product'), align='C')
...
pdf.output('docs/THE_SUBMISSION.pdf')
print(f'PDF generated: docs/THE_SUBMISSION.pdf ({pdf.page_no()} pages)')
