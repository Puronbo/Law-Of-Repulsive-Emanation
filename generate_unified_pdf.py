"""Generate UNIFIED_PROOF.pdf from markdown."""
...
with open('docs/UNIFIED_PROOF.md', 'r', encoding='utf-8') as f:
    md = f.read()
...
safe_multi(pdf, W, 10, sanitize('The Indeterminate Structure of Mathematical Truth'), align='C')
pdf.set_font('Helvetica', '', 10)
safe_multi(pdf, W, 7, 'A Unified Proof Framework via Removable Singularities', align='C')
pdf.set_font('Helvetica', '', 10)
...
pdf.output('docs/UNIFIED_PROOF.pdf')
print(f'PDF generated: docs/UNIFIED_PROOF.pdf ({pdf.page_no()} pages)')
