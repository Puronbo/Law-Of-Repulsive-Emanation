...
In all 56 verified experiments, the removable value is the quantity the theorem asserts, computes, or bounds. This follows from Theorem 10.1: the removable value is not a metaphor for the theorem, it IS the theorem.
