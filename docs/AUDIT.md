...
* **86. Number theory sums 0/0 (2026-08-18)** — 6 sub-experiments: von Mangoldt psi(x)/x -> 1, Euler totient sum phi(k)/k -> 6/pi^2, Mertens product ln(x)*prod(1-1/p) -> 1/e^gamma, Chebyshev bias pi_{4k+3} - pi_{4k+1}, Liouville L(x)/x bounded, totient sum (1/n^2)*sum phi(k) -> 3/pi^2. `data/nt_sums_0_over_0_data.json`.
