...
gluon propagator's pole at p = 0 is removable. This is
consistent with lattice gauge theory computations that show
Sigma(0) > 0 (the gluon acquires an effective mass in the
infrared).

**Honest assessment.** We do not prove Yang-Mills existence
or the mass gap. We identify the 0/0 structure. The problem
requires constructive quantum field theory techniques
[Bricmont, FRohlich, 1995; Balaban, 1985] that go beyond
our framework.
...
- p = 0, p = n (trivial cases)
- p = 1, n = 2 (Lefschetz (1,1) theorem, proved)
- Hodge classes on abelian varieties [Murre, 1982]

The 0/0 framework identifies the conjecture as a surjectivity
condition on a specific map. This does not prove it.

**Honest assessment.** We do not prove the Hodge conjecture.
The problem requires deep algebraic geometry techniques
[Hodge, 1950; Deligne, 1982] beyond our analytic framework.
...
| YM | OPEN | D(0) = 1/Sigma(0) | 1/Delta^2 |
| Hodge | OPEN | alg/image = surjective? | 1 if surjective |
