...
In each of the 70 removable-value experiments, the 0/0 form asks a question, and the removable value is the answer:
...
3. Computing numerically (as we do in all 76 entries)
