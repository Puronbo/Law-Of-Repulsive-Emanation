...
| Gauss-Bonnet via 0/0 | **∫∫K dA = 2πχ(M); 0/0 at zero-curvature points** (2026-08-17): `gauss_bonnet_0_over_0.py` verifies Gauss-Bonnet on S², T², and torus of revolution. S²: GB = 2π·2 (χ=2, all K>0). T²: GB = 0 (χ=0, all vertices near K=0). Torus of revolution: GB = 0 (χ=0, mixed curvature: 107+, 102−, 16≈0). The 0/0: at K=0, angle defect = 2π exactly — the removable value. **HONEST WALL**: computational verification on triangulated surfaces, not a proof (`data/gauss_bonnet_0_over_0_data.json`) |
